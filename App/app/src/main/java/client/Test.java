...
//        }
        ...
        media1.setImage(new File("resources/Star_Wars_Episode_VIII_The_Last_JediGoodRes.png"));
...
//        queryMedia.setTitle(""); //anything set in this query Media will be used as a parameter in the search. producerId and year require exact matches, everything else will perform a "string contains" operation. Any parameter with a ';' will be discarded as safety against sql injection. This means you cannot search multiple actors or showtimes at once.
//        List<Integer> currentMedia = ServerHandler.queryMedia(queryMedia);
//        for (int i : currentMedia) {
//            ServerHandler.deleteMedia(i);
//        }
